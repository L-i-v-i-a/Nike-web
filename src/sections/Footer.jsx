    ...
    <footer id='contact-us' className="max-container">
     ...
     <div className=' flex flex-col items-start'>
        ...
        <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
          Get shoes at affordable prices at your nearest nike store. Find your perfect size.
          Buy for a friend.
        </p>
          ...
          <div key={section}>
            ...
            <ul>
              {section.links.map((link)=> (
                <li key={link.name} className='mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-sky-950 cursor-pointer'>
                  <a>{link.name}</a>
                </li>
              ))}
            </ul>
